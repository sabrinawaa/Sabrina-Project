...
for k in oct_names:
            for j in range(len(strengths)):
                for i in range(len(islands)):
                    twiss_name="Data/25pairs_twiss/twiss.oct="+k+"k3=" +str(strengths[j])+islands[i]+".tfs"
                    twissum_name="Data/25pairs_twiss/twissum.oct="+k+"k3=" +str(strengths[j])+islands[i]+".tfs"
